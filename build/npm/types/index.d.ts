...
declare namespace Fit
{
	...
	*/
	class Array
	{
		...
		* @returns boolean
		*/
		public static CustomRecurse(arr:FileList, callback:(obj:__fitUiAliasFile) => FileList | __fitUiAliasFile[] | null | void):boolean;
		/**
		* Iterates through objects in collection and passes each object to provided callback.
		Callback is expected to return any children supposed to be iterated too, or Null
		if further/deeper iteration is not required.
		...
		*/
		namespace InputTypeDefs
		{
			...
			*/
			class DesignModeConfigPlugins
			{
				...
				*/
				Emojis?:boolean;
				/**
				* Plugin(s) related to support for images (not enabled by default).
			...
			*/
			...
			/**
			* Configuration for table plugins.
			* @class [Fit.Controls.InputTypeDefs.DesignModeConfigPluginsTablesConfig DesignModeConfigPluginsTablesConfig]
			*/
			class DesignModeConfigPluginsTablesConfig
			{
				// Properties defined by Fit.Controls.InputTypeDefs.DesignModeConfigPluginsTablesConfig
				/**
				* Flag indicating whether to enable table plugins or not (defaults to False).
				* @member {boolean} Enabled
				*/
				Enabled:boolean;
			}
