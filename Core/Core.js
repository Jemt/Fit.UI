...
Fit._internal =
{
	Core:
	{
		VersionInfo: { Major: 1, Minor: 7, Patch: 0 } // Do NOT modify format - version numbers are programmatically changed when releasing new versions - MUST be on a separate line!
	}
};
