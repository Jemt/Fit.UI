...
Fit._internal =
{
	Core:
	{
		VersionInfo: { Major: 3, Minor: 5, Patch: 3 } // Do NOT modify format - version numbers are programmatically changed when releasing new versions - MUST be on a separate line!
	}
};
