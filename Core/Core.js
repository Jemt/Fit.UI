...
Fit._internal =
{
	Core:
	{
		VersionInfo: { Major: 2, Minor: 1, Patch: 0 } // Do NOT modify format - version numbers are programmatically changed when releasing new versions - MUST be on a separate line!
	}
};
